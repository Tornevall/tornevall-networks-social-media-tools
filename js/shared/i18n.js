    ...
    var messages = {
        en: {
            ...
            contentScript: {
                ...
                participantScannerTitle: 'SG participant scanner',
                ...
                participantScannerSummary: 'Questions: {questions} · Preview link: {preview}',
                participantScannerAnalyze: 'Analyze in Toolbox',
                participantScannerVerify: 'Verify facts',
                participantScannerLocate: 'Show card',
                participantScannerCardMeta: 'Card {index} · Questions: {questions}',
                participantScannerContextImported: 'Participant request imported into Toolbox.',
        ...
        sv: {
            ...
            contentScript: {
                ...
                participantScannerSummary: 'Frågor: {questions} · Förhandsgranskningslänk: {preview}',
                participantScannerAnalyze: 'Analysera i Toolbox',
                participantScannerVerify: 'Verifiera fakta',
                participantScannerLocate: 'Visa kort',
                participantScannerCardMeta: 'Kort {index} · Frågor: {questions}',
                participantScannerContextImported: 'Deltagarförfrågan importerad till Toolbox.',
                participantScannerVerifySource: 'Verifiering av deltagarförfrågan',
