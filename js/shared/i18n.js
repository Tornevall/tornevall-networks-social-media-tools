        ...
        en: {
            page: {
                popup: {
                    ...
                    moreSettingsHtml: 'More settings and platform-specific tools live in Tools. For more info, <a id="openToolsDashboardLink" href="https://tools.tornevall.net/admin/social-media-tools" target="_blank" rel="noopener noreferrer">open dashboard</a>. You can also <a id="forumLink" href="https://forum.tornevall.net" target="_blank" rel="noopener noreferrer">open the forum</a>.'
                },
                options: {
            ...
            common: {
                ...
                facebookAdminStatsHelperHtml: 'When this is off, Facebook <code>admin_activities</code> pages stay quiet and no statistics overlay is shown. When this is on, you still have to enable reporting separately on each Facebook page before anything is submitted. This master switch is managed from the config page.',
                facebookAdminDebug: 'Enable Facebook admin debug diagnostics',
                facebookSendNow: 'Send queued FB items (active tab)',
                facebookForceRelease: 'Release stuck FB send',
                ...
                customInstructionsHelperHtml: 'For <strong>custom instructions</strong>, use <a id="openToolsDashboardLinkInline" href="https://tools.tornevall.net/admin/social-media-tools" target="_blank" rel="noopener noreferrer">Tools → Social Media Tools</a>.',
            ...
            contentScript: {
                ...
                participantScannerTitle: 'Participant helper',
                participantScannerWaiting: 'Participant scanner is active and waiting for visible request cards.',
                participantScannerDisabled: 'Participant scanner is disabled in Tools.',
                participantScannerMeta: 'Cards enhanced: {count}',
                participantScannerRescan: 'Scan visible cards now',
                participantScannerUnknownCandidate: 'Visible candidate detected',
                participantScannerSummary: 'Questions: {questions} · Groups: {groups} · Preview link: {preview}',
                participantScannerAnalyze: 'Analyze user',
                participantScannerAnalyzeSource: 'Participant user analysis',
                participantScannerAnalyzePendingTitle: '⏳ Analyzing user…',
                participantScannerAnalyzePendingSubtitle: 'Result appears here automatically · Mode: user analysis',
                participantScannerAnalyzeResultTitle: '👤 User analysis via OpenAI',
                participantScannerAnalyzeFailedTitle: '⚠️ User analysis failed',
                participantScannerAnalyzeMode: 'User analysis',
                participantScannerVerifySource: 'Participant request verify',
                participantScannerConfigTitle: 'Participant user-verifier rules',
                participantScannerConfigSubtitle: 'Add group-specific background, approval rules, and risk signals that should be included whenever Analyze user runs on a Facebook participant request.',
                participantScannerConfigPlaceholder: 'Example: This group is for local members only. Treat unanswered membership questions, missing local connection, obvious spam patterns, and brand-new profiles as risk signals. Positive signs include established profile history, relevant answers, and a clear relation to the group topic.',
                participantScannerConfigNote: 'Do not put secrets here. This text is sent as operator-supplied verification context when Analyze user runs.',
                participantScannerConfigOpenInline: 'Rules / group info',
                participantScannerConfigOpenInlineTitle: 'Open the participant user-verifier rule box and update the extra group context used by Analyze user.',
                participantScannerConfigSave: 'Save rules',
                participantScannerConfigSaving: 'Saving…',
                participantScannerConfigSavingStatus: 'Saving participant user-verifier rules…',
                participantScannerConfigSaved: 'Participant user-verifier rules saved. Future analyses will include the updated group context.',
                participantScannerConfigSavedLocal: 'Saved locally in the extension. Add your Tools bearer token if you also want to sync it to Tools.',
                participantScannerConfigSaveFailed: 'Could not save participant user-verifier rules right now.',
                participantScannerConfigOpenTools: 'Open Tools page',
                participantScannerConfigClose: 'Close',
                participantScannerDock: 'Dock participant helper back to the top-right corner.',
                participantScannerUndock: 'Undock participant helper so you can move it freely.',
                participantScannerLocate: 'Show card',
                participantScannerCardMeta: 'Card {index} · Questions: {questions} · Groups: {groups}',
                participantScannerContextImported: 'User analysis imported into Toolbox.',
                participantScannerFoundCards: 'Enhanced {count} visible participant request cards.',
                participantScannerNoCards: 'No visible participant-request cards matched yet.',
                participantScannerScanning: 'Scanning visible participant request cards...',
            ...
            status: {
                ...
                reportingDisabledPopup: ' Reporting is disabled in extension settings. Enable the feature on the config page before the page overlay can appear.',
                ...
                facebookStatsEnabled: 'Facebook admin activity statistics feature enabled in extension settings. Page reporting still stays off until you enable it on each Facebook admin page.',
                facebookStatsDisabled: 'Facebook admin activity statistics feature disabled in extension settings. Facebook admin pages will stay quiet until you enable it again from the config page.',
        ...
        sv: {
            page: {
                popup: {
                    ...
                    moreSettingsHtml: 'Fler inställningar och plattformsspecifika verktyg finns i Tools. För mer info, <a id="openToolsDashboardLink" href="https://tools.tornevall.net/admin/social-media-tools" target="_blank" rel="noopener noreferrer">öppna dashboarden</a>. Du kan också <a id="forumLink" href="https://forum.tornevall.net" target="_blank" rel="noopener noreferrer">öppna forumet</a>.'
                },
                options: {
            ...
            common: {
                ...
                facebookAdminStatsHelperHtml: 'När detta är av håller sig Facebooks <code>admin_activities</code>-sidor tysta och ingen statistik-overlay visas. När detta är på måste du fortfarande aktivera rapportering separat på varje Facebook-sida innan något skickas in. Den globala växelrutan styrs från config-sidan.',
                facebookAdminDebug: 'Aktivera felsökningsdiagnostik för Facebook-admin',
                facebookSendNow: 'Skicka köade FB-poster nu (aktiv flik)',
                facebookForceRelease: 'Frisläpp fastnad FB-skickning',
                apiKey: 'Tools API Bearer Token:',
                ...
                customInstructionsHelperHtml: 'För <strong>egna instruktioner</strong>, använd <a id="openToolsDashboardLinkInline" href="https://tools.tornevall.net/admin/social-media-tools" target="_blank" rel="noopener noreferrer">Tools → Social Media Tools</a>.',
            ...
            contentScript: {
                ...
                participantScannerTitle: 'Deltagarhjälp',
                participantScannerWaiting: 'Participant-scannern är aktiv och väntar på synliga deltagarförfrågningar.',
                participantScannerDisabled: 'Participant-scannern är avstängd i Tools.',
                participantScannerMeta: 'Kort märkta: {count}',
                participantScannerRescan: 'Skanna synliga kort nu',
                participantScannerUnknownCandidate: 'Synlig kandidat upptäckt',
                participantScannerSummary: 'Frågor: {questions} · Grupper: {groups} · Förhandsgranskningslänk: {preview}',
                participantScannerAnalyze: 'Analysera användare',
                participantScannerAnalyzeSource: 'Användaranalys för deltagarförfrågan',
                participantScannerAnalyzePendingTitle: '⏳ Analyserar användare…',
                participantScannerAnalyzePendingSubtitle: 'Resultatet visas här automatiskt · Läge: användaranalys',
                participantScannerAnalyzeResultTitle: '👤 Användaranalys via OpenAI',
                participantScannerAnalyzeFailedTitle: '⚠️ Användaranalysen misslyckades',
                participantScannerAnalyzeMode: 'Användaranalys',
                participantScannerVerifySource: 'Faktakontroll för deltagarförfrågan',
                participantScannerConfigTitle: 'Regler för användarverifiering',
                participantScannerConfigSubtitle: 'Lägg till gruppspecifik bakgrund, godkännanderegler och risksignaler som ska skickas med varje gång Analysera användare körs på en Facebook participant request.',
                participantScannerConfigPlaceholder: 'Exempel: Den här gruppen är bara för lokala medlemmar. Behandla obesvarade medlemsfrågor, saknad lokal anknytning, tydliga spam-mönster och helt nya profiler som risksignaler. Positiva tecken är etablerad profilhistorik, relevanta svar och en tydlig koppling till gruppens ämne.',
                participantScannerConfigNote: 'Lägg inte in hemligheter här. Texten skickas som operatörsstyrd verifieringskontext när Analysera användare körs.',
                participantScannerConfigOpenInline: 'Regler / gruppinfo',
                participantScannerConfigOpenInlineTitle: 'Öppna rutan för användarverifieringsregler och uppdatera den extra gruppkontext som används av Analysera användare.',
                participantScannerConfigSave: 'Spara regler',
                participantScannerConfigSaving: 'Sparar…',
                participantScannerConfigSavingStatus: 'Sparar regler för användarverifieringen…',
                participantScannerConfigSaved: 'Reglerna för användarverifieringen sparades. Kommande analyser använder nu den uppdaterade gruppkontexten.',
                participantScannerConfigSavedLocal: 'Sparat lokalt i tillägget. Lägg till din Tools bearer token om du även vill synka det till Tools.',
                participantScannerConfigSaveFailed: 'Kunde inte spara reglerna för användarverifieringen just nu.',
                participantScannerConfigOpenTools: 'Öppna Tools-sidan',
                participantScannerConfigClose: 'Stäng',
                participantScannerDock: 'Docka tillbaka deltagarhjälpen till övre högra hörnet.',
                participantScannerUndock: 'Lossa deltagarhjälpen så att du kan flytta den fritt.',
                participantScannerLocate: 'Visa kort',
                participantScannerCardMeta: 'Kort {index} · Frågor: {questions} · Grupper: {groups}',
                participantScannerContextImported: 'Användaranalys importerad till Toolbox.',
                participantScannerFoundCards: 'Märkte upp {count} synliga deltagarförfrågningskort.',
                participantScannerNoCards: 'Inga synliga deltagarförfrågningskort matchade ännu.',
                participantScannerScanning: 'Skannar synliga deltagarförfrågningskort...',
            ...
            status: {
                ...
                reportingDisabledPopup: ' Rapportering är avstängd i tilläggets inställningar. Aktivera funktionen på config-sidan innan overlayn kan visas på sidan.',
                ...
                facebookStatsEnabled: 'Funktionen för Facebook-adminstatistik är aktiverad i tilläggets inställningar. Sidrapportering är fortfarande av tills du aktiverar den på varje Facebook-sida.',
                facebookStatsDisabled: 'Funktionen för Facebook-adminstatistik är avstängd i tilläggets inställningar. Facebooks adminsidor håller sig tysta tills du aktiverar den igen från config-sidan.',
